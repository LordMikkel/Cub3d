...
$$
\begin{bmatrix} Entity\_C_X \\ Entity\_C_Y \end{bmatrix} = \frac{1}{\text{Det}(Cam)} \begin{bmatrix} Dir_Y & -Dir_X \\ -Plane_Y & Plane_X \end{bmatrix} \begin{bmatrix} Ene_{X} - Plyr\_X \\ Ene_{Y} - Plyr\_Y \end{bmatrix}
$$

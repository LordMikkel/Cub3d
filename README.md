...
$$
\begin{bmatrix} \text{Entity\_C}_X \\ \text{Entity\_C}_Y \end{bmatrix} = \frac{1}{\text{Det}(Cam)} \begin{bmatrix} Dir_Y & -Dir_X \\ -Plane_Y & Plane_X \end{bmatrix} \begin{bmatrix} Ene_X - Plyr_X \\ Ene_Y - Plyr_Y \end{bmatrix}
$$

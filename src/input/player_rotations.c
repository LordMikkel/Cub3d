...
/*   Updated: 2026/02/09 04:46:37 by migarrid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// necesita mas trabajo, inicializacion, abstraccion y hacer el eje y
void	input_player_rotation(t_data *data)
{
	...
	printf("Mouse: %d, %d | Dir: %f, %f\n", mouse[X], mouse[Y], data->player.dir[X], data->player.dir[Y]);
